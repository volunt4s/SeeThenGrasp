...
surf_model_and_render=dict(
    ...
    rgbnet_full_implicit=True, # by using a full mlp without local feature for rgb, the info for the geometry would be better
    rgbnet_depth=4,
    k_rgbnet_depth=8, # deeper is better
    # k_rgbnet_depth=4,
    ...
    rgbnet_dim=10, # larger is better
