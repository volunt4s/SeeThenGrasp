...
python3 run.py --config ${CONFIG}/fine.py --render_train -p ${WORKDIR} --no_reload --sdf_mode voxurf_fine --scene ${SCENE}

python3 run.py --config ${CONFIG}/fine.py -p ${WORKDIR} --sdf_mode voxurf_fine --scene ${SCENE} --render_only --render_poses

#python3 run.py --config ${CONFIG}/fine.py -p ${WORKDIR} --sdf_mode voxurf_fine --scene ${SCENE} --render_only --mesh_from_sdf
