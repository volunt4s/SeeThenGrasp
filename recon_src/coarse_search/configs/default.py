...
coarse_train = dict(
    ...
    lrate_decay=25,               # lr decay by 0.1 after every lrate_decay*1000 steps
...
'''
# original alpha_init=1e-6
coarse_model_and_render = dict(
    num_voxels=96**3,           # expected number of voxel
    num_voxels_base=96**3,      # to rescale delta distance
